    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="stats">
                ...
                <div class="stat-box">
                    <h3>Scheduled Days Passed</h3>
                    <p>$pastScheduledDays</p>
                </div>
                <div class="stat-box">
                    <h3>Scheduled Days Remaining</h3>
                    <p>$futureScheduledDays</p>
                </div>
            </div>
            
            <h3>Progress</h3>
            <div class="progress-bar">
                <div class="progress" style="width: $(($commitCount / $totalScheduledDays) * 100)%;"></div>
            </div>
            <p>$commitCount out of $totalScheduledDays days completed ($(($commitCount / $totalScheduledDays) * 100)%)</p>
        </div>
        ...
        <div class="card">
            ...
            <p>Last run date: <strong>$lastRunDate</strong></p>
        </div>
        ...
        <div class="card">
            ...
            <ul class="schedule-list">
                $(foreach ($day in $nextCommitDays) {
                    ...
                    if ($day -eq $todayStr) {
                        "<li class='today'><strong>$day</strong> (Today!)</li>"
                    } else {
                        "<li><strong>$day</strong> (in $daysUntil days)</li>"
                    }
                })
            </ul>
        </div>
        ...
        <div class="card">
            ...
            <p>Task state: <strong>$taskState</strong></p>
            <p>Last run time: <strong>$lastRunTime</strong></p>
            <p>Next run time: <strong>$nextRunTime</strong></p>
        </div>
