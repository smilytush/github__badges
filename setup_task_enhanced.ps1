# This script sets up the Windows Task Scheduler tasks to run the enhanced_workflow.ps1 script twice daily
# Path to the repository
$repoPath = "J:\green-commits"
$scriptPath = "$repoPath\enhanced_workflow.ps1"

# Morning task name and description
$morningTaskName = "GitHub Workflow - Morning"
...
$afternoonTaskName = "GitHub Workflow - Afternoon"
