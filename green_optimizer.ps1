...
Write-Log "Average commits per day: $([Math]::Round($intensityMap.Values | Measure-Object -Average | Select-Object -ExpandProperty Average, 2))"
...
Write-Log "Run enhanced_workflow_fixed.ps1 to start making commits with the optimized schedule."
