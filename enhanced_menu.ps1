...
function Clean-Repository {
    ...
    Write-Host "- enhanced_workflow.ps1" -ForegroundColor White
    Write-Host "- enhanced_dashboard.ps1" -ForegroundColor White
    Write-Host "- enhanced_menu.ps1" -ForegroundColor White
    ...
    # Rename main script
    if (Test-Path "enhanced_workflow.ps1" -and -not (Test-Path "green_commit.ps1")) {
        Copy-Item "enhanced_workflow.ps1" "green_commit.ps1"
        Write-Host "Created green_commit.ps1 from enhanced_workflow.ps1" -ForegroundColor Green
